...
export const MobileActionCapsuleBar: React.FC<MobileActionCapsuleBarProps> = ({
  ...
  return (
    <div className={cn("sticky top-[-8px] z-30 bg-action-bridge text-white py-3 px-3 min-h-[58px] flex items-center justify-around shadow-md dark:shadow-none gap-1.5 transition-all duration-300 overflow-x-auto scrollbar-hide", className)}>
