...
export default function TransactionSidePanel({
  ...
  return (
    <>
      <CustomModal
        ...
        body={
          <div className="flex-1 overflow-y-auto px-4 py-4 bg-muted/10">
            {receiptData ? renderReceiptContent() : (
            ...
            <div className="flex flex-col gap-3 w-full pb-4">
              ...
              {isRefundDisabled ? (
                <Tooltip 
                  ...
                  placement="top"
                  className="max-w-xs text-xs py-1.5 px-3 text-center bg-card/70 backdrop-blur"
                >
      ...
      {isOpen && receiptData && typeof document !== 'undefined' && createPortal(
